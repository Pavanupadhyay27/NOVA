...
const serviceCatalog: ServiceItem[] = [
  ...
  },
  {
    id: 'local-seo',
    num: '07',
    category: 'NEIGHBORHOOD MAP 3-PACK',
    categoryGroup: 'search',
    shortCategory: 'Local Proximity',
    title: 'Hyperlocal Local SEO & Maps',
    tagline: 'Dominate "near me" searches across Patia, Saheed Nagar, Infocity, and Cuttack with rigorous citation networks.',
    ...
    deliverables: ['Google Business Profile 100%', 'Patia & Infocity Geo-Grid', '5.0★ Review Velocity'],
    metric: 'Top 3',
